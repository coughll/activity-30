...
let cmd = prompt("Input a command.");
if (cmd == "print") {print()}
if (cmd == "verify") {verify(prompt("Input an employee name:"))}
if (cmd == "lookup") {lookup(prompt("Enter an employee name:"))}
if (cmd == "contains") {contains(prompt("Enter a string:"))}
if (cmd == "update") {update(prompt("Enter an employee name:"))}
if (cmd == "add") {add(prompt("Enter a name to add:"))}
if (cmd == "delete") {deleteEmployee(prompt("Enter name of employee to delete:"))}
